...
export function AdminReportes() {
  ...
  const buscar = async () => {
    ...
    try {
      const res = await triageApi.getReporte(
        ...
        <>
          ...
          {triages.length > 0 && (
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm text-gray-400">{triages.length} registros encontrados</p>
                    ...
                    return (
                      <tr key={t.id} className="border-b border-gray-800/50 hover:bg-gray-800/30 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          ...
                          <p className="text-xs text-gray-400">{t.numeroDocumento} · {t.edad} años</p>
                        </td>
                ...
                return (
                  <div key={t.id} className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
                    ...
                    <div className="px-5 py-3 border-b border-gray-800/50">
                      ...
                      <p className="text-xs text-gray-500 mt-1">Tiempo de atención: {t.tiempoAtencion}</p>
                    </div>
                    ...
                    {(t.todosSintomas?.length > 0 || t.observaciones) && (
                      <div className="px-5 py-3 border-t border-gray-800/50">
                          ...
                          <div className="mb-2">
                            ...
                            <div className="flex flex-wrap gap-1.5">
                              ...
                              {sintomasNormales.map(s => (
                                <span key={s} className="px-2 py-0.5 bg-gray-800 text-gray-300 text-xs rounded-md">
                                  {s}
                                </span>
                              ))}
                            </div>
                        ...
                        <p className="text-xs text-gray-600 mt-2">Registrado por: {t.usuarioRegistra}</p>
                      </div>
                    )}
                  </div>
                )
